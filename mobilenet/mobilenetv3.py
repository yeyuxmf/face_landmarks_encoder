...
class MobileNetV3_Small(nn.Module):
    ...
    def forward(self, x):
        ...
        bneck = []
        for layer in self.bneck:  # 直接迭代Sequential对象
            x = layer(x)
            bneck.append(x)
        # out = self.bneck(out)
        layer2, layer3, layer4 = bneck[2], bneck[7], bneck[10]
...
class MobileNetV3_Large(nn.Module):
    ...
    def forward(self, x):
        ...
        for layer in self.bneck:  # 直接迭代Sequential对象
            ...
            bneck.append(x)
        # out = self.bneck(out)
        layer2, layer3, layer4 = bneck[5],bneck[11],bneck[14]
